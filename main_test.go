...
func CriaAlunoMock() {
	aluno := models.Aluno{Nome: "Nome do Aluno Teste", CPF: "36544876287", RG: "758934723"}
...
func TestBuscaAlunoPorCPFHandler(t *testing.T) {
	...
	req, _ := http.NewRequest("GET", "/alunos/cpf/36544876287", nil)
	resposta := httptest.NewRecorder()
	r.ServeHTTP(resposta, req)
	assert.Equal(t, http.StatusOK, resposta.Code)
}
...
func TestBuscaAlunoPorIDHandler(t *testing.T) {
	...
	assert.Equal(t, "36544876287", alunoMock.CPF)
	assert.Equal(t, "758934723", alunoMock.RG)
	assert.Equal(t, http.StatusOK, resposta.Code)
}
...
func TestEditaUmAlunoHandler(t *testing.T) {
	...
	aluno := models.Aluno{Nome: "Nome do Aluno Teste", CPF: "00544876287", RG: "008934723"}
	...
	assert.Equal(t, "00544876287", alunoMockAtualizado.CPF)
	assert.Equal(t, "008934723", alunoMockAtualizado.RG)
